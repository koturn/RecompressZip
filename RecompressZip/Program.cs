        ...
        private static bool IsCharKey(ConsoleKeyInfo cki)
        {
            return cki.Key switch
            {
                ConsoleKey.Backspace
                    ...
                    or ConsoleKey.Select
                    or ConsoleKey.Print
                    or ConsoleKey.Execute
                    or ConsoleKey.PrintScreen
                    or ConsoleKey.Insert
                    or ConsoleKey.Delete
                    or ConsoleKey.Help
                    or ConsoleKey.LeftWindows
                    or ConsoleKey.RightWindows
                    or ConsoleKey.Applications
                    or ConsoleKey.Sleep
                    or ConsoleKey.F1
                    or ConsoleKey.F2
                    or ConsoleKey.F3
                    ...
                    or ConsoleKey.F23
                    or ConsoleKey.F24
                    or ConsoleKey.BrowserBack
                    or ConsoleKey.BrowserForward
                    or ConsoleKey.BrowserRefresh
                    or ConsoleKey.BrowserStop
                    or ConsoleKey.BrowserSearch
                    or ConsoleKey.BrowserFavorites
                    or ConsoleKey.BrowserHome
                    or ConsoleKey.VolumeMute
                    or ConsoleKey.VolumeDown
                    or ConsoleKey.VolumeUp
                    or ConsoleKey.MediaNext
                    or ConsoleKey.MediaPrevious
                    or ConsoleKey.MediaStop
                    or ConsoleKey.MediaPlay
                    or ConsoleKey.LaunchMail
                    or ConsoleKey.LaunchMediaSelect
                    or ConsoleKey.LaunchApp1
                    or ConsoleKey.LaunchApp2
                    or ConsoleKey.Process
                    or ConsoleKey.Packet
                    or ConsoleKey.Attention
                    or ConsoleKey.CrSel
                    or ConsoleKey.ExSel
                    or ConsoleKey.EraseEndOfFile
                    or ConsoleKey.Play
                    or ConsoleKey.Zoom
                    or ConsoleKey.NoName
                    or ConsoleKey.Pa1
                    or ConsoleKey.OemClear => false,
                _ => true
            };
        }
